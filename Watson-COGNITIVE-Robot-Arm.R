...
repeat
{
    ...
    if(grepl("pinch", response)){python.exec("ser.write('a')")} 
    if(grepl("release", response)){python.exec("ser.write('z')")}
    
    if(grepl("curl", response)){python.exec("ser.write('s')")} #
    if(grepl("wave", response)){python.exec("ser.write('x')")} #
    
    if(grepl("elbow", response)){python.exec("ser.write('c')")} #
    if(grepl("extend", response)){python.exec("ser.write('d')")} #
    
    if(grepl("shoulder", response)){python.exec("ser.write('f')")} #
    if(grepl("salute", response)){python.exec("ser.write('v')")} #
    
    if(grepl("right", response)){python.exec("ser.write('g')")} #
    if(grepl("left", response)){python.exec("ser.write('b')")} #
    ...
    if(grepl("talk", response)){boaty_speaks("Hello, My name is MacKenzie! Let's be friends.  OK?")}
